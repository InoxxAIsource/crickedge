...
## Recent Changes
- 2026-02-17: Edge Audit — Built institutional-grade audit system: timestamp integrity analysis (100% single-TS innings = systematic bias), realistic simulation with 5% commission + slippage + execution delay, leakage risk classification (25% critical, 8.5% high, 66% medium). Added 7th dashboard page "Edge Audit" with 4 tabs. Honest assessment: 27.7% avg edge is inflated by stale single-timestamp odds; real edge likely 4-8% after per-over alignment.
